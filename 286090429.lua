...
local Window = OrionLib:MakeWindow({Name = "Galaxy Hub - Arsenal", HidePremium = false, SaveConfig = false, IntroText="GalaxyHub"})
...
while true do
    ...
    Url = "http://51.222.65.251:80/authenticate",
    Method = "POST",
    Headers = {
    ...
    if Response.Body ~= "user authenticated" then
        game.Players.LocalPlayer:Kick(tostring(Response.Body))
    end
